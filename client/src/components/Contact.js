                            ...
                            <div class="card-body p-3 container">
                                <section className = "row">
                                    ...
                                    <div className = "col-10">
                                        ...
                                        <p className = "fw-normal text-secondary p-0 m-0 contact-card-info">7000985825</p>
                                    </div>
                                </section>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-3 container">
                                <section className = "row">
                                    ...
                                    <div className = "col-10">
                                        ...
                                        <a href = "mailto:reachshubhishukla@gmail.com" className = "fw-normal text-secondary p-0 m-0 contact-card-info text-decoration-none">harshitaranawat06@gmail.com</a>
                                    </div>
                                </section>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-3 container">
                                <section className = "row">
                                    ...
                                    <div className = "col-10">
                                        ...
                                        <p className = "fw-normal text-secondary p-0 m-0 contact-card-info">Gwalior, MP, India</p>
                                    </div>
                                </section>
                            </div>
                        </div>
